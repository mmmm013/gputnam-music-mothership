        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#FFFDF5]/60 border border-[#8B4513]/30 p-2 rounded-full backdrop-blur-md max-w-sm flex items-center shadow-lg">
               <input type="text" placeholder="How are you feeling?" className="bg-transparent border-none outline-none text-[#5D4037] placeholder-[#8B4513]/50 px-4 w-full font-medium" />
            </div>
          ...
          <div className="relative h-[500px] w-full bg-[#8B4513] rounded-sm p-4 shadow-2xl flex flex-col md:flex-row shadow-[#8B4513]/40 border-4 border-[#5D4037]">
            <div className="w-full h-full border-2 border-[#DAA520]/50 rounded-sm flex flex-col md:flex-row overflow-hidden bg-[#2C241B]">
              ...
              {/* ZONE 1: HERO PORTRAIT (Sienna/Red-Brown) */}
              ...
              {/* ZONE 2: FEATURED CONTENT (FIX: Light Brown / Latte Blend) */}
              {/* Changed from #B8860B (Mustard) to #D2B48C (Tan/Light Brown) */}
              <div className="w-full md:w-1/2 h-full bg-gradient-to-br from-[#D2B48C] to-[#C19A6B] flex flex-col items-center justify-center p-6 text-center relative group hover:from-[#DEB887] hover:to-[#D2B48C] transition-all cursor-pointer">
